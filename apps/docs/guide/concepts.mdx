...
<Tip>
  References can be optional (`fieldTypes.reference("Author").optional()`) or
  collected in arrays (`z.array(fieldTypes.reference("BlogPost"))`). The
  resolution engine handles both forms.
</Tip>
